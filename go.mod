...
require (
	...
	mes-app v0.0.0-00010101000000-000000000000
)
...
replace mes-app => ../mes-app

// 本地 genproto（解决 go-admin-core 拉入旧版 genproto 导致的包路径歧义）
replace (
	google.golang.org/genproto => ../go-genproto
	google.golang.org/genproto/googleapis/api => ../go-genproto/googleapis/api
	google.golang.org/genproto/googleapis/rpc => ../go-genproto/googleapis/rpc
)
